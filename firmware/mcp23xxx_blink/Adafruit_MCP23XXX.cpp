...
*/
/**************************************************************************/
bool Adafruit_MCP23XXX::pinMode(uint8_t pin, uint8_t mode) {
  ...
  bool dirOk = dir_bit.write((mode == OUTPUT) ? 0 : 1);
...
*/
/**************************************************************************/
bool Adafruit_MCP23XXX::digitalWrite(uint8_t pin, uint8_t value) {
  ...
  return pin_bit.write((value == LOW) ? 0 : 1);
}
...
uint8_t Adafruit_MCP23XXX::readIoDir() {
  Adafruit_BusIO_Register GPIO(i2c_dev, spi_dev, MCP23XXX_SPIREG,
